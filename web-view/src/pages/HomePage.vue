...
for (let index = 0; index < 10; index++) {
    extensions.extensionArray.push({
        pck: {
            ...
            extensionPack: ["Lorem ipsum", "Lorem ipsum", "Lorem ipsum", "Lorem ipsum"],
...
<template>
    <div class="outer">
        <div class="top">
            <h3 class="title">Extension Pack Management</h3>
            <button class="create">
                <div class="content">
                    <div class="icon">
                        <svg t="1684216155601" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="2598" :width="size" :height="size">
                            <path
        ...
        <div class="bottom">
            <div class="extensionPack" v-for="item, key in extensions.extensionArray" :key="key">
                ...
                <vscode-badge class="packNum">{{ item.pck.extensionPack.length }}</vscode-badge>
                <div class="info">
...
@topHeight: (@outerHeight - @bottomHeight )* 0.4;
@topWidth: @outerWidth;
