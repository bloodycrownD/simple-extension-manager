            ...
            <div class="item" v-for="item in extensions.customExtensionPack" :key="`extension:${item?.dirName}`">
                <div :class="{ extensionPack: true, activeExtensionPack: item.isClicked }" @click="resolveClick(item)">
                    ...
                    <div class="zip" @click.stop="pack(item)">
                        <SimpleTip content="pack" top="-20px" height="15px" width="34px" padding-top="1px" right="-28px">
                    ...
                    <div class="edit" @click.stop="update(item)">
                        <SimpleTip content="edit" top="-20px" height="15px" width="34px" padding-top="1px" right="-30px">
                    ...
                    <div class="delete" @click.stop="deleteExtension(item)">
                        <SimpleTip content="delete" top="-20px" height="15px" width="40px" padding-top="1px" right="-35px">
