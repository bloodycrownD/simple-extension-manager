...
<template>
    <div class="outer">
        <div class="left">
            <div class="extension" v-for="item in store.extensionArray" :key="`extension:${item?.dirName}`">
        ...
        <div class="middle">
            <img :src="defaultImg" draggable="false" class="icon">
            <div class="info">
                <div class="displayName">
                    <vscode-text-field placeholder="input the display name" class="text" type="text" size="200">
                        <h2 style="line-height: 0;text-align: center;">DisplayName</h2>
                    </vscode-text-field>
                </div>
                <div class="discription">
                    <vscode-text-field placeholder="input the discription" class="text" type="text" size="200">
